import{j as e,a as r}from"./index-CdoV4dTa.js";import{i as o}from"./iconsMap-DUkz239I.js";import{M as d}from"./index-CSmOe9xl.js";function u({icon:t,title:a,description:i,link:s,onClick:n}){return e.jsxs("div",{className:"project-card",onClick:n,children:[e.jsxs("h3",{children:[t," ",a]}),e.jsx("a",{href:s,target:"_blank",rel:"noopener noreferrer",children:"Link to the website"}),e.jsx("p",{className:"desc-text",children:i}),e.jsx("p",{className:"details-hint",children:"More details →"})]})}function m({project:t,onClose:a}){return e.jsx("div",{className:"popup-overlay",onClick:a,children:e.jsxs("div",{className:"popup-box",onClick:i=>i.stopPropagation(),children:[e.jsxs("div",{className:"popup-header-container",children:[e.jsx("h2",{className:"popup-title gradient-text",children:t.title}),e.jsx("button",{className:"popup-close-icon",onClick:a,children:e.jsx("img",{src:o.close,alt:"Close"})})]}),e.jsxs("div",{className:"popup-body-container",children:[e.jsx("div",{className:"popup-readme",children:t.details&&e.jsx("div",{className:"markdown-body",children:e.jsx(d,{children:t.details})})}),t.repo&&e.jsx("div",{className:"popup-link",children:e.jsxs("a",{href:t.repo,target:"_blank",rel:"noopener noreferrer",className:"project-link",children:[e.jsx(r,{})," View Repository"]})})]})]})})}const h=[{icon:"AI",title:"Interactive RAG Assistant",description:"A full-stack retrieval-augmented generation app with document ingest, vector search, grounded citations, and a portfolio-native React UI.",repo:"https://github.com/aadishrath/aadishrath.github.io",details:`This project turns the portfolio into an interactive Retrieval-Augmented Generation system that users can actually query. It combines a React 19 frontend with a FastAPI backend, local vector retrieval, and optional OpenAI-powered answer synthesis for higher quality grounded responses.
    ...
    ## 🛠️ Setup Instructions
      Must follow all steps in order. 3 terminal windows will be used here.
        ...
        4. Run UI Script
    `},{icon:"😀",title:"Sentiment Analysis Platform",description:"A modular, full-stack sentiment analysis application that demonstrates foundational and advanced NLP techniques.",repo:"https://github.com/aadishrath/sentimentAnalysis",details:`A modular, full-stack sentiment analysis application that demonstrates foundational and advanced NLP techniques. Built with a scalable backend, interactive React frontend, and integrated analytics logging, this project is designed for real-world deployment and resume impact.
  ...
  `},{icon:"📊",title:"Logistic regression for predictions",description:"The project is built and trained using logistic regression model using TensorFlow, PyTorch and Scikit-Learn library.",repo:"https://github.com/aadishrath/MatchPredictor",details:`In this project, I built and trained logistic regression model using TensorFlow, PyTorch and Scikit-Learn library. This project has large league of legends dataset with 9 columns and 1000 rows. win is the target feature and kills, deaths, assists, gold-earned, cs, wards_placed, wards_killed, damage_dealt are input features.
    ...
    `}],g=[{icon:"🌐",title:"Mock Banking App",link:"https://adirathore7.github.io",description:"A responsive and modern mock banking app built with React and Tailwind CSS to showcase React hooks and state management.",repo:"https://github.com/adirathore7/adirathore7.github.io",details:`
    ...
    `},{icon:"🌐",title:"Personal Portfolio Website",link:"https://aadishrath.github.io",description:"A responsive and modern personal portfolio website built with React and Tailwind CSS to showcase projects and skills.",repo:"https://github.com/aadishrath/aadishrath.github.io",details:`
    ...
    `}];export{u as P,m as a,g as f,h as m};
